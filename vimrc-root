...
"mapping langmap
set langmap=ФТШРВНГОПСМЗЬДЫКЧЩЖЛАЮБИЕЯ;ABCDEFGHIJKLMNOPQRSTUVWXYZ,фтшрвнгопсмзьдыкчщжлаюбиея;abcdefghijklmnopqrstuvwxyz
...
" модуль включения проверки орфографии
if version >= 700
...
"вставка содержимого заданного файла, дополнение по Tab в тек.каталоге
imap <F3> <Esc>:read
map <F3> <Esc>:read
